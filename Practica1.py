...
people = ["CÉSAR","GABRIELA","JULIETTA","CAMILO","ANGEL"]
...
print("nos informaron que escucharon gritos de un hombre, aparentemente del señor identificado como Sr. Billetes.")
print("Al llegar a la casa, encontramos el cuerpo sin vida del Sr. Billetes en ",color.BOLD + room + color.END," y aparentemente el arma homicida fue un@ ",color.RED + weapon + color.END," que estaba junto a él")
...
# descubridor de culpable  
            ...
            if guilty == killer:
                print ("¡Lo has descubierto!", killer, "asesinó al Sr. Billetes en " ,room, "usando" ,weapon)
                break
            else:
